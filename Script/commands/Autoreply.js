...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    ...
    "help": "Prefix de sala",
    "hi": "এত হাই-হ্যালো কর ক্যান প্রিও amr boss Rahat Ke dekho na inbox koro..!😜🫵",
    ...
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ RAHAT 𝗕𝗕𝗭𝗭\nhttps://www.facebook.com/profile.php?id=61585114784110",
 ...
 "AMI ABIR": "ভুল হয়ছে বস😩মাফ করে দাও🙏💩",
 ...
 "শালা চুপ কর": "ওকে Rahat বস😗",
    "heda": "এতো রাগ শরীরের জন্য ভালো না 😛",
    "boda": "ভাই তুই এত হাসিস না..!🌚🤣",
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss Rahat এর ইনবক্সে গুতা দিন 😘",
